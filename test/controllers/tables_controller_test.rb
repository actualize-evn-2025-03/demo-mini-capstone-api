...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference("Table.count") do
      post tables_url, params: { table: { description: @table.description, height: @table.height, width: @table.width } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { description: @table.description, height: @table.height, width: @table.width } }
